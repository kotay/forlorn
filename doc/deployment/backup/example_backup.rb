...
# 0 0,12 * * * /bin/bash -l -c "RAILS_ENV=production backup perform -t sirport_backup --config_file /home/you/sirport_backup.rb" 2>&1 >> /home/you/sirport_backup_log.txt

# In backups.password on your server:
#   some password

# In sirport_backup.rb on your server put an edited version of the following file.  REMEMBER TO EDIT THE FILE!

# You'll also need to install the backup gem on your server, as well as the net-ssh, excon, net-scp, and fog gems.

Backup::Model.new(:sirport_backup, 'The Sirport backup configuration') do
